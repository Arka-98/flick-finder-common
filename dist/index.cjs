...
var Public = () => (0, import_common.SetMetadata)(IS_PUBLIC, true);
...
_AuthGuard_decorators = [(0, import_common3.Injectable)()];
var AuthGuard = class {
...
AuthGuard = __decorateElement(_init, 0, "AuthGuard", _AuthGuard_decorators, AuthGuard);
...
_RoleGuard_decorators = [(0, import_common4.Injectable)()];
var RoleGuard = class {
...
RoleGuard = __decorateElement(_init2, 0, "RoleGuard", _RoleGuard_decorators, RoleGuard);
...
_ParseObjectIdPipe_decorators = [(0, import_common5.Injectable)()];
var ParseObjectIdPipe = class {
  transform(value) {
    if (!(0, import_mongoose.isValidObjectId)(value)) {
      throw new import_common5.BadRequestException("Invalid ObjectId");
    }
    return import_mongoose.Types.ObjectId.createFromHexString(value);
  }
};
_init3 = __decoratorStart(null);
ParseObjectIdPipe = __decorateElement(_init3, 0, "ParseObjectIdPipe", _ParseObjectIdPipe_decorators, ParseObjectIdPipe);
